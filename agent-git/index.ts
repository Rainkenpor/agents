...
async function handler(
  ...
  try {
		const mcpServer = new McpServer({ name: "mcp-git", version: "1.0.0" });
	...
	credentials: [
		{
			...
			required: false,
			description:
				"Carpeta raíz donde se clonan los repos efímeros (default: tmpdir/agent-git-repos)",
		},
		{
			key: "GIT_REPO_TTL_MS",
			required: false,
			description:
				"Tiempo de vida de un repo clonado en ms antes de auto-eliminarse (default: 3600000 = 1h)",
		},
	],
